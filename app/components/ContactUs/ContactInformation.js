                ...
                <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="text-center">
                            ...
                            <h3 className="font-light text-base leading-[20px] mb-4 text-dark">{t('contactPage.contactInfo.email')}</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-light text-base leading-[20px] mb-4 text-dark">{t('contactPage.contactInfo.phone')}</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="font-light text-base leading-[20px] mb-4 text-dark">{t('contactPage.contactInfo.businessHours')}:</h3>
