  ...
  return (
    <div className={`w-full ${locale === "fa" ? "rtl" : "ltr"}`}>
      ...
      <section className="py-16">
        <div className="max-w-[952px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-dark text-[30px] leading-[37.5px] font-bold mb-4">
              {t("contactPage.form.title")}
            </h2>
            <p className="text-[#4D637B] text-[20px] leading-[25px] font-light">
          ...
          <form className="space-y-4 w-full max-w-[952px] mx-auto ">
            ...
            <div className="pt-2 sm:pt-4 w-full flex justify-center">
              <button
                style={{
                  background:
                    "linear-gradient(90deg, #1848AD 0%, #11337A 100%)",
                }}
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8">
        <div
          className="max-w-[1380px] h-[492px] mx-auto text-center rounded-[40px] pt-4 px-4 sm:p-10"
          style={{
            backgroundImage:
              "url('/assets/connect-on-professional-networks.jpg')",
        ...
        >
          <div className="w-full h-full flex items-end sm:items-center justify-end">
            <div className="bg-white w-full rounded-[24px] p-6 sm:p-10 max-w-[548px] -mb-20 sm:-mb-0">
              <h2 className="text-dark text-[24px] sm:text-[30px] leading-[30px] sm:leading-[37.5px] font-bold mb-6">
                {t("contactPage.social.title")}
              </h2>
              <p className="text-dark text-[18px] leading-[22.5px] font-light mb-6">
      ...
      <section className="pt-28 pb-14 sm:py-16">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-dark text-[30px] leading-[37.5px] font-bold mb-2">
            {t("contactPage.newsletter.title")}
          </h2>
          <p className="text-dark text-base leading-[20px] font-light mb-8">
            {t("contactPage.newsletter.subtitle")}
          </p>
      ...
      <section className="pb-20 pt-12 md:py-16">
        <div className="max-w-[952px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-dark text-[18px] leading-[22.5px] font-normal mb-10">
