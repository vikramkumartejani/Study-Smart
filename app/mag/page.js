...
export default function Mag() {
    ...
    const recentArticles = t('magPage.sections.recentArticles.articles').map((article, index) => ({
        ...article,
        image: recentArticleImages[index] || recentArticleImages[0],
        alt: article.title
    }));

    const trendingTopics = t('magPage.sections.trendingTopics.topics').map((topic, index) => ({
        ...topic,
        image: trendingTopicImages[index] || trendingTopicImages[0],
        alt: topic.title
    }));

    const quickLinks = t('magPage.sections.quickLinks.articles').map((link, index) => ({
        ...link,
        ...
        <div className={`w-full bg-[#FCFCFC] ${locale === 'ar' ? 'rtl' : 'ltr'}`}>
                    ...
                    <div className="flex flex-col justify-center mt-2 lg:mt-4">
                        ...
                        >
                            ...
                            <Image
                                ...
                                alt={locale === 'ar' ? 'سهم للمزيد' : 'Read more arrow'}
                                width={20}
                                height={20}
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href="/recent-articles" className="text-[#1848AD] text-[14px] font-normal leading-[17.5px] flex items-center gap-2">
